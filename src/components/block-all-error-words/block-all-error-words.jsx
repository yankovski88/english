...
const BlockAllErrorWords = (props)=>{
  const {activeWords, allErrorWords}=props;
  console.log(allErrorWords);
  const arrWords = [];
  for (const word of allErrorWords){
...
export default connect(mapStateToProps, null)(BlockAllErrorWords); // mapDispatchToProps
